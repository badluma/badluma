...
Hello, aka badluma, and I am interested in coding and AI (not vibe coding). My main language is Python, but I want to learn languages like C, C++, and Rust too (I'm not too interested in web development).
